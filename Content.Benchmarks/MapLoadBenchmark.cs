...
public class MapLoadBenchmark
{
    ...
    public static string[] MapsSource { get; } = { "Empty", "Satlern", "Box", "Bagel", "Dev", "CentComm", "Core", "TestTeg", "Packed", "Omega", "Reach", "Meta", "Marathon", "MeteorArena", "Fland", "Oasis", "Cog", "Convex", "Plasma" };
