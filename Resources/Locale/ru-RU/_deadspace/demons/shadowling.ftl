...
shadowling-ascendance-announcement = Внимание! Мы фиксируем вознесение тенеморфа на вашей станции! Сектор полностью изолирован, любые попытки покинуть его будут пресекаться огнём Блюспейс Артиллерии. Для локализации и нейтрализации угрозы будет задействован флот СССП. Благодарим за сотрудничество и преданность отечеству!
shadowling-ascendance-sender = Секторальный Штаб НКВБ
...
shadowling-alert-announcement = Внимание экипажу станции! На связи Секторальный управление ГШ! Нами зафиксирована аномальная демоническая активность в вашем секторе. Вам будет отправлен Специальный Отряд Быстрого Реагирования для локализации и нейтрализации источника угрозы. Всему персоналу станции следовать указаниям Советской Гражданской Милиции. Ожидайте прибытия в кратчайшие сроки. Слава СССП!
shadowling-alert-sender = Генеральный Штаб
