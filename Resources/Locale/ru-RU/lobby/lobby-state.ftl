...
lobby-state-background-text = Фон: [color=white]{$backgroundTitle}[/color] от художника [color=white]{$backgroundArtist}[/color]
lobby-state-background-no-background-text = Фон не загружен.
