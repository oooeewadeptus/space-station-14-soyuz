...
ent-VisitorIDCard = ID-карта посетителя
    .desc = { ent-IDCardStandard.desc }
ent-CentcomIDCard = ID-карта офицера ГШ
    .desc = { ent-IDCardStandard.desc }
...
ent-CentcomIDCardSyndie = ID-карта офицера командования
    .desc = { ent-IDCardStandard.desc }
    .suffix = Фальшивый
ent-CentcomOfficialIDCard = ID-карта представителя ГШ
    .desc = { ent-CentcomIDCard.desc }
ent-CentcomAdministratorIDCard = ID-карта администратора ГШ
    .desc = { ent-CentcomIDCard.desc }
ent-CentcomOperatorIDCard = ID-карта оператора ГШ
    .desc = { ent-CentcomIDCard.desc }
ent-CentcomSpecialOperationsOfficerIDCard = ID-карта генерала специальных операций
    .desc = { ent-CentcomIDCard.desc }
ent-CentcomFieldOfficerIDCard = ID-карта полевого офицера НКВБ
    .desc = { ent-CentcomIDCard.desc }
