...
ent-PunctAutoInjector = автоинъектор пунктураза
    .desc = Экспресс-доза пунктураза, предназначенная для применения в боевых условиях.
...
ent-JetInjector = инъектор
    .desc = Стерильный инъектор для удобного введения лекарственных препаратов пациентам. Благодаря его без игольному способу ввода, его можно использовать для тех кто боиться уколов!
