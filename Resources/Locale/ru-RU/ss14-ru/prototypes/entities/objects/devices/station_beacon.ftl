...
ent-DefaultStationBeaconLawOffice = { ent-DefaultStationBeaconSecurity }
    .suffix = Офис системного агента прокуратуры
    .desc = { ent-DefaultStationBeaconSecurity.desc }
